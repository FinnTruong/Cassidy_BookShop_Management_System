...
namespace CassidyBookStore {
    ...
    public partial class QLNSDataSet : global::System.Data.DataSet {
        ...
        public partial class BOOKSDataTable : global::System.Data.TypedTableBase<BOOKSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BOOKSRow AddBOOKSRow(string BOOKTITLE, string AUTHOR, int QUANTITY, double COST, double PRICE) {
...
namespace CassidyBookStore.QLNSDataSetTableAdapters {
    ...
    public partial class BOOKSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[BOOKS] WHERE (([ID] = @Original_ID) AND ((@IsNull_BOOKTITLE = 1 AND [BOOKTITLE] IS NULL) OR ([BOOKTITLE] = @Original_BOOKTITLE)) AND ((@IsNull_AUTHOR = 1 AND [AUTHOR] IS NULL) OR ([AUTHOR] = @Original_AUTHOR)) AND ((@IsNull_QUANTITY = 1 AND [QUANTITY] IS NULL) OR ([QUANTITY] = @Original_QUANTITY)) AND ([COST] = @Original_COST) AND ([PRICE] = @Original_PRICE))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BOOKS] ([BOOKTITLE], [AUTHOR], [QUANTITY], [COST], [PRICE]) VA" +
                "LUES (@BOOKTITLE, @AUTHOR, @QUANTITY, @COST, @PRICE);\r\nSELECT ID, BOOKTITLE, AUT" +
                "HOR, QUANTITY, COST, PRICE FROM BOOKS WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[BOOKS] SET [BOOKTITLE] = @BOOKTITLE, [AUTHOR] = @AUTHOR, [QUANTITY] = @QUANTITY, [COST] = @COST, [PRICE] = @PRICE WHERE (([ID] = @Original_ID) AND ((@IsNull_BOOKTITLE = 1 AND [BOOKTITLE] IS NULL) OR ([BOOKTITLE] = @Original_BOOKTITLE)) AND ((@IsNull_AUTHOR = 1 AND [AUTHOR] IS NULL) OR ([AUTHOR] = @Original_AUTHOR)) AND ((@IsNull_QUANTITY = 1 AND [QUANTITY] IS NULL) OR ([QUANTITY] = @Original_QUANTITY)) AND ([COST] = @Original_COST) AND ([PRICE] = @Original_PRICE));
SELECT ID, BOOKTITLE, AUTHOR, QUANTITY, COST, PRICE FROM BOOKS WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CassidyBookStore.Properties.Settings.Default.QLNSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, BOOKTITLE, AUTHOR, QUANTITY, COST, PRICE FROM dbo.BOOKS";
        ...
        public virtual int Fill(QLNSDataSet.BOOKSDataTable dataTable) {
        ...
        public virtual QLNSDataSet.BOOKSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLNSDataSet.BOOKSDataTable dataTable = new QLNSDataSet.BOOKSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLNSDataSet.BOOKSDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_BOOKTITLE, string Original_AUTHOR, global::System.Nullable<int> Original_QUANTITY, double Original_COST, double Original_PRICE) {
        ...
        public virtual int Insert(string BOOKTITLE, string AUTHOR, global::System.Nullable<int> QUANTITY, double COST, double PRICE) {
            if ((BOOKTITLE == null)) {
        ...
        public virtual int Update(string BOOKTITLE, string AUTHOR, global::System.Nullable<int> QUANTITY, double COST, double PRICE, int Original_ID, string Original_BOOKTITLE, string Original_AUTHOR, global::System.Nullable<int> Original_QUANTITY, double Original_COST, double Original_PRICE, int ID) {
            if ((BOOKTITLE == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string BOOKTITLE, string AUTHOR, global::System.Nullable<int> QUANTITY, double COST, double PRICE, int Original_ID, string Original_BOOKTITLE, string Original_AUTHOR, global::System.Nullable<int> Original_QUANTITY, double Original_COST, double Original_PRICE) {
            return this.Update(BOOKTITLE, AUTHOR, QUANTITY, COST, PRICE, Original_ID, Original_BOOKTITLE, Original_AUTHOR, Original_QUANTITY, Original_COST, Original_PRICE, Original_ID);
        }
    }
